...
\end{equation*}
%Let be $k=n$ and $0 \leq n \leq i$ hence the identity for iterated rascal number yieds
%\begin{align*}
%    \rascalNumber{2i+1-n}{n}{i}         &= \binom{2i+1-n}{n}
%\end{align*}
%By symmetry $\rascalNumber{2i+1-n}{2i+1-2n}{i} = \binom{2i+1-n}{2i+1-2n}$
%for each $t \geq 2i+1, \; 0 \leq n \leq t-i-1$ follows
%\begin{align*}
%    \rascalNumber{t-n}{t-2n}{t-i-1}     &= \binom{t-n}{t-2n}
%\end{align*}
\begin{proof}
